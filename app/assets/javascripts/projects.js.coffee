$ ->
  $('div.actions :first').click ->
    total_number_input_field = $('div.field:last').children().length
    $('div.field:last').append('
      <p>
        ...
        <input type="hidden" value="0" name="project[file_projects_attributes]['+total_number_input_field+'][remove_file]">
